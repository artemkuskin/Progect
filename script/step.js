    ...
    (modolFunc = (e) => {
        if (e.target.classList.contains("content__ingredients-button-next")) {
            if (
                ...
                document.querySelector('.content__ingredients-button-next-back').style.display = "block"
            } else if (
                document.querySelector("#content__ingredients-price").className ===
                "breads"
            ) {
            ...
            if (
                ...
                document.querySelector(".filling").style.background =
                    "rgb(206, 60, 60)";
                document.querySelector('.content__ingredients-button-next').style.display = "block"
                document.querySelector('.content__ingredients-button').style.flexDirection = "row-reverse"
            } else if (
                document.querySelector("#content__ingredients-price").className ===
                "fillings"
            ) {
                ...
                document.querySelector('.content__ingredients-button-next-back').style.display = "none"
            }
            resultModal();
        }
    })
