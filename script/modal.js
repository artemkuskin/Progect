const resultModal = async() => {
    ...
    if (
        ...
        modalWindow +=
            "<p>Размер:<strong id='sizes-name' class='-1'>" + obj.nameSizes + "</strong></p> ";
        modalWindow +=
            "<p>Хлеб:<strong id='breads-name'  class='-1'>" + obj.nameBreads + "</strong></p>";
        modalWindow +=
            "<p>Овощи:<strong id='veget-name'  class='-1'>" + obj.nameVeget + "</strong></p>";
        modalWindow +=
            "<p>Соусы:<strong id='sous-name'  class='-1'>" + obj.nameSous + "</strong></p>";
        modalWindow +=
            '<p>Начинка:<strong id="fill-name"  class="-1">' + obj.nameFill + "</strong></p>";
...
const targetEtem = () => {
    if (
        ...
        if (obj.objCancelSizes === obj.objSizes) {
            if (document.getElementById(obj.objSizes)) {
        ...
        if (obj.objCancelBreads === obj.objBreads) {
            if (document.getElementById(obj.objBreads)) {
        ...
        if (obj.objCancelVeget === obj.objVeget) {
            if (document.getElementById(obj.objVeget)) {
        ...
        if (obj.objCancelSaus === obj.objSaus) {
            if (document.getElementById(obj.objSaus)) {
        ...
        if (obj.objCancelFill === obj.objFill) {
            if (document.getElementById(obj.objFill)) {
