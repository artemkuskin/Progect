...
document.addEventListener(
    ...
    (createActive = (e) => {
        ...
        if (
            ...
            if (e.target.classList.contains("price-popup") && !document.querySelector('.active')) {
                ...
                console.log(obj);
            } else if (e.target.classList.contains("price-popup") && document.querySelector('.active')) {
                ...
                itog.innerText = +itog.innerText + +price2.textContent - priceItem.innerText;
                block.className = "active"
                let nameSizes = document.getElementById(`${"n" + id}`).innerText;
                obj.objSizes = id;
                obj.nameSizes = nameSizes;
